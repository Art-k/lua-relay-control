...
--        end
  ...
  --                  print("\n\n")
    ...
    --                              TODO here we need to add send new status to server, no need to wait timer
                                ...
                                elseif b1['Command'] == "FILE" then
                                  if b1['SubCommand'] == "file" then
                                    print(b1['url'])
                                  end
                                end
                                print(gpio.read(Pin))
                                ...
                                tmr.create():alarm(2000, tmr.ALARM_SINGLE, function() sendStatus() end)
--
                              end
                            end
                          end
